          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                ...
                @endif
              <form action="{{ route('register.save') }}" method="POST" class="user" id="register">
                @csrf
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block sumbmit_btn">Register Account</button>
              </form>
              <hr>
              <div class="text-center">
    ...
    $('#register').on('submit', function(e) {
        ...
        $.ajax({
            ...
            complete: function() {
                    ...
                    $('.sumbmit_btn').prop('disabled', false).html('Register Account');
